  ...
  return (
    <main className="min-h-screen bg-background pb-24">
      ...
      <div className="mx-auto mt-8 flex max-w-[1280px] flex-col gap-8 px-3">
        ...
        <div className="slide-shell"><Slide><Header n="06"/><div className="h-full px-14 pb-12 pt-24"><Title kicker="Market opportunity">A focused wedge into a global category.</Title><div className="mt-9 grid grid-cols-3 items-stretch gap-4">
          <div className="bg-deep p-6 text-primary-foreground"><p className="text-xs font-bold text-primary">TAM · GLOBAL</p><p className="display mt-3 text-4xl font-extrabold">$42.8B</p><p className="mt-3 text-xs leading-relaxed text-primary-foreground/65">Smart-city intelligence platforms, predictive infrastructure analytics & hyper-local retail media. <span className="font-bold text-primary">14.8% CAGR.</span></p></div>
          <div className="bg-primary p-6 text-primary-foreground"><p className="text-xs font-bold">SAM · SA & SADC</p><p className="display mt-3 text-4xl font-extrabold">$440M</p><p className="mt-3 text-xs leading-relaxed text-primary-foreground/75">SLA contractor compliance & municipal analytics across 744 priority wards in 257 municipalities.</p></div>
          <div className="bg-signal p-6 text-accent-foreground"><p className="text-xs font-bold">SOM · METRO BEACHHEAD</p><p className="display mt-3 text-4xl font-extrabold">$24.5M</p><p className="mt-1 text-xs font-bold">ARR</p><p className="mt-2 text-xs leading-relaxed">584 active wards · 7 metros · ~$42K ARR/ward across 4 rails.</p></div>
        </div><div className="mt-5 flex items-center gap-3 bg-muted px-5 py-3 text-xs font-bold"><span>Municipal recovery</span><ArrowRight size={14}/><span>Contractor SaaS</span><ArrowRight size={14}/><span>Insurance risk APIs</span><ArrowRight size={14}/><span>SME local placements</span></div></div></Slide></div>
